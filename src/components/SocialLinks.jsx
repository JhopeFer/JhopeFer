...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@arya_chinesegirlwanters",
    icon: Instagram,
    url: "https://www.instagram.com/arya_chinesegirlwanters/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@artagames",
    icon: Youtube,
    url: "https://www.youtube.com/@artagames",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@thinkaura",
    icon: Github,
    url: "https://github.com/thinkaura",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@thinkaura",
    color: "black",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-red-600 rounded-full"></span>
        Connect With Me
      </h3>
